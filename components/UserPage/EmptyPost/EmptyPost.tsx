...
const EmptyPost : FC = ({}) => {
  return (
    <article className="bg-white border-xs border-opacity-20 border-gray3 w-full px-5 text-center flex flex-col items-center justify-center h-488px">
      ...
      <p className="text-black text-opacity-40 text-sm md:text-base mt-4 mb-5">Support or follow creators to see posts in your feed</p>
      <Button px="px-8" height='h-50px' onClick={() => {}} text='Find creators you love' type='primary' className="mb-5"  />
      <EmptyPostImage />
    </article>
  )
}
