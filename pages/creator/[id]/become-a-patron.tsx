          ...
          {!isLoading && creator ?
            <>
              <CreatorShowcase img={creator.coverPhoto}>
                <div style={{backgroundImage: `url(${creator.profilePhoto})`}} className='bg-center bg-no-repeat w-40 h-40 md:w-181px md:h-181px border-10px border-white rounded-50% absolute left-1/2 bottom-0 -translate-x-1/2  translate-y-1/2'></div>
              </CreatorShowcase>
              <div className='lg3:container mx-auto'>
                <div className='text-center mt-24 mb-10 md:mb-16'>
                  ...
                  <p className='text-black text-opacity-60 font-light text-base'>{creator.isAreCreating}</p>
                </div>
